...
function game_finished.load( prev_state, ... )
   ...
   buttons_with_url.add_to_layout(
	 ...
	 text = "Development by Mick McCarthy",
	 url = "https://github.com/mc-carthy/lvArkanoid",
...
function game_finished.mousereleased(x, y, button, istouch)
